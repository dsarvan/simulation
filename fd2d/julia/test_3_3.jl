...
function surfaceplot(ns::Int, nx::Int, ny::Int, npml::Int, ez::Array{Float32})::Nothing
...
function contourplot(ns::Int, nx::Int, ny::Int, npml::Int, ez::Array{Float32})::Nothing
